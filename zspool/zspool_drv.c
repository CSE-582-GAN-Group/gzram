...
//	snprintf(zram->cdev_dev.kobj.name, 16, "zspool%d", device_id);
//
//	/* Actual capacity set using sysfs (/sys/block/zspool<id>/disksize */
...
MODULE_DESCRIPTION("Zspool Character Device");
